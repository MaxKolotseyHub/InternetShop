    ...
    class DbInitializer : DropCreateDatabaseAlways<DatabaseContext>
    {
        protected override void Seed(DatabaseContext context)
        {
            ...
            Product product = new Product
            {
                ...
                Title = "Стамеска",
                Count = 5,
                Description = "Стамеска деревянная для стругания",
                Images = new List<Image> { images },
                Price = 47.2,
            };
    
            //Description description1 = new Description { Text = "Топор лесника" };
            Image images1 = new Image { Path = "data:image/jpeg;base64," };
            Producer producer1 = new Producer { Name = "БелЛесникТорг", Country = "Беларусь" };
            Product product1 = new Product
            {
                Category = category,
                Title = "Топор",
                Count = 7,
                Description = "Топор лесника",
                Images = new List<Image> { images1 },
                Price = 90.2,
            };
            ...
            Client client1 = new Client { Adress = "Krasnaya str.", FirstName = "Svetka", LastName = "Vorobieva", MobilePhoneNumber = "+375255675657" };
            Client client2 = new Client { Adress = "Zelenaya str.", FirstName = "Olya", LastName = "Kuznetsova", MobilePhoneNumber = "+375297656547" };

            Purchase purchase1 = new Purchase
            {
                Client = client1,
                DateTime = DateTime.Now,
                Products = new List<Product> { product, product1 }
            };
